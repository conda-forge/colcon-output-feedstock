...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/colcon-output-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/colcon-output-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add colcon-output
# for installing globally
pixi global install colcon-output
```
...
It is possible to list all of the versions of `colcon-output` available on your platform:
...
```
pixi search colcon-output --channel conda-forge
```
